---
title: 'AI生图-服装细节'
api: 'POST https://ai-nebula.com/prod-api/nebula/v4/api/clothingDetailsSubmit'
---
...
<Tabs>
  <Tab title="cURL示例">
    ```bash
    curl -X POST "https://ai-nebula.com/prod-api/nebula/v4/api/clothingDetailsSubmit" \
      ...
      -d '{
        ...
        "temperature": 1,
        "watermark": false,
        "image": "https://example.com/clothing-detail.jpg"
      }'
    ```
  </Tab>
  <Tab title="Python示例">
    ...
    url = "https://ai-nebula.com/prod-api/nebula/v4/api/clothingDetailsSubmit"
    headers = {
