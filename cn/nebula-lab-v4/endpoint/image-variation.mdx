---
title: 'AI生图-裂变生图'
api: 'POST https://ai-nebula.com/prod-api/nebula/v4/api/imageVariationSubmit'
---
...
<Tabs>
  <Tab title="cURL示例">
    ```bash
    curl -X POST "https://ai-nebula.com/prod-api/nebula/v4/api/imageVariationSubmit" \
  ...
  <Tab title="Python示例">
    ...
    url = "https://ai-nebula.com/prod-api/nebula/v4/api/imageVariationSubmit"
    headers = {
