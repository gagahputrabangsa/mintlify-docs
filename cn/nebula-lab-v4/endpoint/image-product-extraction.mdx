---
title: 'AI生图-商品提取'
api: 'POST https://ai-nebula.com/prod-api/nebula/v4/api/productExtractionSubmit'
---
...
<Tabs>
  <Tab title="cURL示例">
    ```bash
    curl -X POST "https://ai-nebula.com/prod-api/nebula/v4/api/productExtractionSubmit" \
  ...
  <Tab title="Python示例">
    ...
    url = "https://ai-nebula.com/prod-api/nebula/v4/api/productExtractionSubmit"
    headers = {
