---
title: 'AI生图-智能去印'
api: 'POST https://ai-nebula.com/prod-api/nebula/v4/api/smartWatermarkRemovalSubmit'
---
...
<Tabs>
  <Tab title="cURL示例">
    ```bash
    curl -X POST "https://ai-nebula.com/prod-api/nebula/v4/api/smartWatermarkRemovalSubmit" \
      -H "Content-Type: application/json" \
      -H "Authorization: Bearer sk-xxxxxxxxxx" \
      -d '{
        "model": "doubao-seedream-4-0-250828",
        "prompt": "去除图片中的水印，保持画面自然",
        "n": 1,
        "size": "1024x1024",
        "temperature": 1,
        "watermark": false,
        "image": "https://example.com/with-watermark.jpg"
      }'
    ```
  </Tab>
  <Tab title="Python示例">
    ...
    url = "https://ai-nebula.com/prod-api/nebula/v4/api/smartWatermarkRemovalSubmit"
    headers = {
